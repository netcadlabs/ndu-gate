...
class HardHatDetectorRunner(NDUCameraRunner):
    def __init__(self, config, _connector_type):
        ...
        # # self.onnx_fn = "/data/small_30.onnx"
        # self.onnx_fn = "/data/best.onnx"
        # # self. = "/data/last.onnx"
        # self.input_size = 640

        self.onnx_fn = "/data/yolov4_helmet.onnx"
        self.input_size = 416
    ...
    def process_frame(self, frame, extra_data=None):
        ...
        res = yolo_helper.predict_v4(self.onnx_fn, self.input_size, self.class_names, frame)
        no_helmet_count = 0
        helmet_count = 0
